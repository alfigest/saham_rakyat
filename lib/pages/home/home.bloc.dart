...
import 'package:saham_rakyat_test/models/meal.model.dart';
import 'package:saham_rakyat_test/pages/home/home.event.dart';
import 'package:saham_rakyat_test/pages/home/home.state.dart';
import 'package:saham_rakyat_test/services/meal.service.dart';
...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  void _onSelectCategory(
      OnSelectCategory event, Emitter<HomeState> emit) async {
    try {
      emit(state.copy(
